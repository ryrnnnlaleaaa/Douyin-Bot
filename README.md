...
Python + ADB helper that scrolls Douyin, scores faces via Tencent’s API, and likes/follows when beauty exceeds your threshold; calibrate `config/` if your screen size is not 1920×1080.
